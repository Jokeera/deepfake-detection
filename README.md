...
### Cross-dataset evaluation (DFDC02 → DFD01, 3420 видео)

| Модель | DFDC02 AUC | DFD01 AUC | Δ AUC |
|--------|-----------|-----------|-------|
| **A1: Full (dual-path)** | 0.9777 | **0.5531** | -0.4246 |
| A2: Spatial-only | 0.9835 | 0.5037 | -0.4798 |
| A3: Temporal-only | 0.9655 | N/A | — |
| A4: Sequential | 0.9715 | N/A | — |

Dual-path модель обобщает лучше: temporal branch снижает падение AUC на 5.5% при cross-dataset.
