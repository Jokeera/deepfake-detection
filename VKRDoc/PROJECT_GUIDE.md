...
> **Вывод**: добавление CelebDF повысило AUC с 0.899 до 0.959 (+6.0%) за счёт улучшения баланса классов и разнообразия методов манипуляции. Full dual-path модель — лучшая на 3 датасетах.

### Эксперимент 5: T=32 (увеличенное число кадров)

Ноутбуки подготовлены (`kaggle-train-3ds-t32-A1..A4.ipynb`), тренировка запланирована при доступности GPU квоты.
